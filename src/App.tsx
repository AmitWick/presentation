...
import { initialColorState } from "./redux/slice/initialColorSlice";
              ...
              {isFullScreen && (
                ...
                >
                  <ReactCanvas
                    ...
                    defaultTool="laser"
                    defaultStrokeColor={strokeColor.penColorOnImage}
              ...
              {isFullScreen && (
                ...
                >
                  <ReactCanvas
                    currentSlide={current}
                    defaultTool="pen"
                    defaultStrokeColor={strokeColor.penColorOnBlackboard}
                    tool={blackBoardTool}
              ...
              {isFullScreen && (
                ...
                >
                  <ReactCanvas
                    currentSlide={current}
                    defaultTool="pen"
                    defaultStrokeColor={strokeColor.penColorOnWhiteboard}
                    tool={whiteBoardTool}
